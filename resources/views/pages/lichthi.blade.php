...
@extends('master')
@section('title')
Lịch Thi | Khoa CNTT - ĐH Mở TP.HCM
@stop
@section('define-css')
	...
	<main class="main-content">
        <section class="header-news">
            <ul class="breadcrumb">
                ...
                <li class="active"><a href="/lich-thi">lịch thi</a></li>
            </ul>
            <div class="news-title"><a href="/lich-thi " title="">lịch thi</a></div>
        </section>
        <section class="content-news">
            <div class="container">
                    <div class="row" data-toggle="tooltip">
                        @foreach($l_news as $item)
